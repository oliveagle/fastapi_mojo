...
echo "[1/3] Building hello_build.mojo..."
mojo build "$ROOT/src/fastapi_mojo/hello_build.mojo" -o "$OUTPUT_DIR/fastapi_mojo"
...
echo ""
echo "=== Test Run ==="
cd "$OUTPUT_DIR" && ./fastapi_mojo && echo "OK: binary runs without LD_LIBRARY_PATH"
